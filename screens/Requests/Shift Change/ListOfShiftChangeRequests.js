...
const ListOfShiftChangeRequests = ({ navigation }) => {
        ...
        <NativeBaseProvider>
            ...
            <HStack backgroundColor='#0F74B3' justifyContent='space-between' alignItems='center' px={4} pb={3} pt={12 + StatusBar.currentHeight}>
                <HStack alignItems='center'>
                    ...
                    <Text fontFamily={fonts.PopSB} fontSize={22} ml={6} color='white'>Shift Change Requests</Text>
                </HStack>

                <TouchableOpacity onPress={() => navigation.navigate('CreateShiftChangeRequest')}>
...
export default ListOfShiftChangeRequests;
