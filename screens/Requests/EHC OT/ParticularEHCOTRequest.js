...
const ParticularEHCOTRequest = ({ navigation, route }) => {
        ...
        <NativeBaseProvider>
            ...
            <HStack backgroundColor='#0F74B3' justifyContent='space-between' alignItems='center' px={4} pb={3} pt={12 + StatusBar.currentHeight}>
                <HStack alignItems='center'>
                    ...
                    <Text fontFamily={fonts.PopSB} fontSize={22} ml={6} color='white'>EHC/OT Request Detail</Text>
                </HStack>
            </HStack>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ paddingTop: 10, marginTop: 10, paddingBottom: 200 }}>
                <VStack px={4} mb={5}>
                    ...
                    <HStack style={styles.infoCard}>
                        <HStack alignItems='center'>
                            <Entypo name="v-card" size={20} color="black" />
                            <Text style={styles.title}>OT Hours</Text>
                        </HStack>
                        <Text style={styles.value}>{item?.OTHours}</Text>
                    </HStack>
                    ...
                    <HStack style={styles.infoCard}>
                        <HStack alignItems='center'>
                            <Entypo name="v-card" size={20} color="black" />
                            <Text style={styles.title}>Actual OT Hours</Text>
                        </HStack>
                        <Text style={styles.value}>{item?.ActualOTHours}</Text>
                    </HStack>
                    ...
                    <HStack style={styles.infoCard}>
                        <HStack alignItems='center'>
                            <Entypo name="v-card" size={20} color="black" />
                            <Text style={styles.title}>Approved OT Hours</Text>
                        </HStack>
                        <Text style={styles.value}>{item?.ApprovedOTHours}</Text>
                    </HStack>
...
export default ParticularEHCOTRequest;